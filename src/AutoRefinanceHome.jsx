...
function HomeScreen() {
  return (
    <div className="flex flex-col items-center justify-start min-h-screen text-center px-4 pt-10 pb-6 md:pt-6 md:pb-4">
      ...
      <Link
        to="/application"
        className="bg-blue-600 text-white px-6 py-3 rounded-md text-lg font-medium hover:bg-blue-700 mb-8"
      >
        Start Application
      </Link>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-left max-w-xl mb-8 shadow-sm">
        ...
        <ol className="list-decimal list-inside space-y-2 text-gray-700">
          ...
          <li>Review any offer and accept refinance terms 📝</li>
          <li>Use your virtual card to pay off your current car loan 💳</li>
