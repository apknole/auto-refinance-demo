    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      <header className="flex justify-between items-center p-6 border-b border-gray-200">
        ...
        <nav className="space-x-6 text-sm font-medium">
          ...
          <a href="#" className="hover:text-blue-600 text-blue-600 font-semibold">Status</a>
          <a href="#" className="hover:text-blue-600">Virtual Card</a>
          <a href="#" className="hover:text-blue-600" onClick={handleViewTransactions}>Transactions</a>
        </nav>
      </header>

      {showTransactions ? <TransactionHistory /> : isLoading ? (
